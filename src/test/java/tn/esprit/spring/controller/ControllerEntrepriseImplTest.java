...
public class ControllerEntrepriseImplTest {
	...
	public void testaffecterDepartementAEntreprise() throws ParseException {
		...
		logger.debug("affecting Departement ("+d.getId()+","+d.getName()+") to Entreprise ("+e.getId()+","+e.getName()+")...");
		...
		logger.debug("Department ("+d1.getId()+","+d1.getName()+","+d1.getEntreprise().getId()+") fetched.");
